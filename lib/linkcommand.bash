...
#g++ -shared -WL,-install_name,libdream.so -Wl,-undefined -Wl,dynamic_lookup -o "/Users/marcfervil/Documents/Programming/Dreamlang/lib/libdream.so" "/Users/marcfervil/Documents/Programming/Dreamlang/lib/dream.o"  -lllvm -undefined dynamic_lookup -L/usr/local/opt/llvm/lib  -lz -ltermcap -lc++ -lLLVMCore -lLLVMSupport -lLLVMTransformUtils -lLLVMBitReader -lLLVMAnalysis -lLLVMDemangle -dynamiclib `llvm-config --ldflags -libs` -fPIC
...
g++ -shared -WL,-install_name,libdream.so -Wl,-undefined -Wl,dynamic_lookup -o libdream.so dream.o  -lllvm -undefined dynamic_lookup -L/usr/local/opt/llvm/lib  -lz -ltermcap -lc++ -lLLVMCore -lLLVMSupport -lLLVMTransformUtils -lLLVMBitReader -lLLVMAnalysis -lLLVMDemangle -dynamiclib `llvm-config --cxxflags --ldflags --system-libs --libs all` -fPIC
cp dream.o "/Users/marcfervil/Documents/Programming/Dreamlang/lib/dream.o"
cp libdream.so "/Users/marcfervil/Documents/Programming/Dreamlang/lib/dream.so"
