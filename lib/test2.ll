...
then26:                                           ; preds = %then
  ...
  %35 = call %dreamObj* @dreamStr(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @12, i32 0, i32 0))
  store %dreamObj* %35, %dreamObj** %str_stack29, align 8
  ...
  store %dreamObj* %36, %dreamObj** %func_stack31, align 8
  ...
  %37 = bitcast i8* %value_temp34 to %dreamObj* (...)*
  %38 = call %dreamObj* (...) %37(i32 1, %dreamObj* %str30)
  br label %ifcont

ifcont:                                           ; preds = %then26, %then
  store i32 8, i32* @line, align 4
  %39 = call %dreamObj* (%dreamObj*, i8*, i32, ...) @get_var(%dreamObj* %new_scope10, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @13, i32 0, i32 0), i32 1)
  %func_stack35 = alloca %dreamObj*, align 8
  %40 = call %dreamObj* @dreamFunc(i8* bitcast (void (i32, %dreamObj*, ...)* @print to i8*))
  store %dreamObj* %40, %dreamObj** %func_stack35, align 8
  %func36 = load %dreamObj*, %dreamObj** %func_stack35, align 8, !var_args !0
  %memberptr37 = getelementptr %dreamObj, %dreamObj* %func36, i32 0, i32 2
  %value_temp38 = load i8*, i8** %memberptr37, align 8
  %41 = bitcast i8* %value_temp38 to %dreamObj* (...)*
  %42 = call %dreamObj* (...) %41(i32 1, %dreamObj* %39)
  %null_dream39 = load %dreamObj*, %dreamObj** @nullDream, align 8
  %43 = icmp ne %dreamObj* %19, %null_dream39
  br i1 %43, label %for_start, label %forcont
